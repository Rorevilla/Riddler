...
additional_elements <- additional_elements + draw_label("There are six scenarios where                        wins the election, with just 24.3% of the popular vote", x = 0.5, y = 0.96,colour = "black",fontface="bold",size=12)
